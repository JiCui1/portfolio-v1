      ...
      <main className="items-center relative justify-items-center min-h-screen p-8 pb-20 gap-16 sm:ps-10" >
        ...
        <section className="mt-40" id="about">
            ...
            <div className="w-3/5 mx-auto text-xl">
              ...
              <p className="">I graduated with a BEng degree in <strong>Mechanical Engineering</strong> from  Ontario Tech University. After working as a Mechanical Engineer for 2 years, I decided to transition into software because all the cool things happening on this side so I did a Interactive Media Design and Web Development program from Durham College.</p>
              ...
              <p className="">My dev setup is <strong>Kitty Terminal, Tmux, Neovim, Fish shell.</strong> (Is it worth it to switch to Nushell? 🤔)</p>
